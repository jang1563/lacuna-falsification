...
| **`make` targets** | `Makefile` | `make venv`, `make test` (118/118 local-runnable as of 2026-04-25 package review), `make smoke` (~22s fast judge-visible confidence check), `make audit`, `make h1`, `make h2`, `make paper`, `make prereg-audit`, `make rejection-log`, `make skeptic-review` |
