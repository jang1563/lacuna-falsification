...
- 105/105 local-runnable tests in the current `make test` target · 2026-04-26 `make smoke` OK · GitHub public, `make all` runnable end-to-end without credentials.
...
- 105/105 local-runnable tests pass via `make test` (review/staging suites are intentionally ignored by that target).
