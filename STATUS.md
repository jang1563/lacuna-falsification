...
| **PhL-15** | HONEST NULL — adaptive thinking ON/OFF causal ablation on Opus 4.7 Skeptic (120 calls): both modes 0/60 PASS, identical dissent rate, identical metric-citation specificity. Adaptive thinking is NOT the isolated mechanism behind E2's Opus-vs-Sonnet gap | `results/live_evidence/phl15_adaptive_thinking/SUMMARY.md` |
| **PhL-16** | Cross-model Proposer quality (see verdict) — Opus 30/30 valid proposals, Sonnet 18/30 (parse failures), Haiku 0/30 (adaptive-thinking + JSON format ceiling) | `results/live_evidence/phl16_proposer_quality/SUMMARY.md` |
